...
bash search.sh challenge-corpus ../data/challenge/train/train.token.code challenge-exemplars/train.exemplar ../data/challenge/val/test.token.code challenge-exemplars/val.exemplar ../data/challenge/test/test.token.code challenge-exemplars/test.exemplar
